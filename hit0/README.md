...
- Un mensaje es consumido por un solo consumer
...
|----------------|-------------------------|--------------------------|---------------|-------------------------|
| **Tipo de comunicación** | Punto a punto | Broadcast (uno a muchos) | Punto a punto | Punto a punto |
| **Destinatarios** | Un solo consumer | Múltiples consumers | Un solo consumer | Un solo consumer |
